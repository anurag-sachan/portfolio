...
const Work = () => {
  return (
    <div className='text-white p-3 sm:p-24 h-fit bg-gradient-to-br from-black via-gray-800 to-cyan-700'>
    <div className='m-6 text-2xl text-center'>My Work Domain</div>
        <container class='grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3'>
            ...
            <div class="px-6 py-4">
                <div class="font-bold text-xl text-black text-start mb-3">Backend Dev</div>
            ...
            <div class="px-6 pt-4 pb-2">
                ...
                <span class="inline-block bg-gray-200 rounded-full px-3 py-1 text-sm font-semibold text-gray-700 mr-2 mb-2">py: flask</span>
            ...
            <div class="px-6 pt-4 pb-2">
                <p className='text-base text-blue-600 underline'><a href='https://drive.google.com/file/d/1vnd2p2_pLufKjx5P1wTEeFga3jQIEKPJ/view?trk=public_profile_see-credential' target='_blank' rel='noreferrer'>Certificate: WorldQuant Brain - Gold Alpha.</a></p>
            </div>
            <div class="px-6 pt-4 pb-2">
                <span className='text-black text-sm font-semibold'>Tech:&nbsp;</span>
